...
-keep class com.mobilewizards.logging_app.FilesAdapter { *; }
-keepclassmembers class com.mobilewizards.logging_app.FilesAdapter$FileViewHolder { *; }
...
# Preserve Data Binding (ActivitySendSurveysBinding)
-keep class com.mobilewizards.logging_app.databinding.ActivitySendSurveysBinding { *; }
